...
function (_React$Component) {
  ...
  function Visualizer() {
    ...
    _defineProperty(_assertThisInitialized(_assertThisInitialized(_this)), "onDocumentMouseWheel", function (event) {
      ...
      camera.projectionMatrix = new three__WEBPACK_IMPORTED_MODULE_1__["Matrix4"]().makePerspective(camera.fov, window.innerWidth / window.innerHeight, camera.near, camera.far);
    });
  ...
  _createClass(Visualizer, [{
    ...
    value: function componentDidMount() {
      document.addEventListener("mousewheel", onDocumentMouseWheel, false); //3D SCENE
...
//# sourceMappingURL=index.js.884e5756d3ce46392a8c.hot-update.js.map