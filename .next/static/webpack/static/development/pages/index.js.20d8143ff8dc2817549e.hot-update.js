...
function (_React$Component) {
  ...
  function Visualizer() {
    ...
    _defineProperty(_assertThisInitialized(_assertThisInitialized(_this)), "onDocumentMouseWheel", function (event) {
      ...
      _this.camera.fov = Math.max(Math.min(_this.camera.fov, fovMAX), fovMIN);
      _this.camera.projectionMatrix = new three__WEBPACK_IMPORTED_MODULE_1__["Matrix4"]().makePerspective(_this.camera.fov, window.innerWidth / window.innerHeight, _this.camera.near, _this.camera.far);
    });
...
//# sourceMappingURL=index.js.20d8143ff8dc2817549e.hot-update.js.map